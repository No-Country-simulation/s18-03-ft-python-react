...
export default function LandingPage() {
  ...
  return (
    <main className=''>
      ...
      <p className='text-spotify-white text-center font-semibold'>Join to see your stats and engage with other music lovers!</p>
      ...
      <section className='mt-[2rem]'>
        ...
        <div className='mt-[1rem] flex flex-col justify-center gap-[1rem] md:flex-row w-[100%]'>
        <MostListened/>
        <MostListened/>
        </div>
      </section>
